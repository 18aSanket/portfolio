                    ...
                    <div class="owl-carousel" >
                        <div class="item zoom-on-hover">
                            <a class="lightbox" href="asset/img/website/bizrock.png">
                                ...
                                <span class="description">
                                    <span class="description-body">1</span>
                                </span>
                            </a>
                        </div>
                        <div class="item zoom-on-hover">
                            <a class="lightbox" href="asset/img/website/bizrock.png">
                                <img class="img-fluid image" src="asset/img/website/bizrock.png">
                                <span class="description">
                                    <span class="description-body">2</span>
                                </span>
                            </a>
                        </div>
                        ...
                        <div class="item zoom-on-hover">
                            <a class="lightbox" href="asset/img/website/bizrock.png">
                                <img class="img-fluid image" src="asset/img/website/bizrock.png">
                                <span class="description">
                                    <span class="description-body">3</span>
                                </span>
                            </a>
                        </div>
                    </div>
...
<div class="col-md-6">
   <iframe class="row" src="asset/coolstuff/random-image.html" width="100%" height="200px" style="border: none"></iframe>
    <a href="asset/coolstuff/random-image.html" class="text-white">Random image every refresh
        <br>- View -</a>
...
<!-- ------------------------------------------------------------------- -->
                ...
                <div class="text-center text-white mybg" id="contact">
                    ...
                    <div class="container">
                        ...
                        <p class="text-white">Want to chat about something?</p>
